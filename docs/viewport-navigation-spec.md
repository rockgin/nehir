...
| Invert Wheel Scroll Direction | Bool | `true` | Flips the wheel-to-viewport mapping for both Column Steps and Free Scroll. On by default; turn off to use the standard wheel direction. |
